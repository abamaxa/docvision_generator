...
class AbstractAugmentor(object) :
    def __init__(self, question, tiler, options) :
        ...
        self.image = None # question.get_image()
        self.frames = None# question.get_frames()
        
        self.augmented_image = None
        self.augmented_frames = None
        
        self.current = 0
        self.count = int(len(question.get_frames()["text"]) * 1.5)
    ...
    def draw_debug_rects(self) :
        ...
        for rect in self.augmented_frames["text"] :
